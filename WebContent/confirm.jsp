...
<html>
<head>
<title> Ticker for you | Confrim Payment </title>
...
<body>
	...
	<form name="input" action="viewPayment.jsp" method="post">
	
	<h5>Your Product Details</h5><p>(Ex. Product Name X: 1 / Product Name Y: 2)</p>
		<input type="text" name="ProductDetail">
	
	<h5>Shipping</h5><p>Delivery Cost: EMS 50 Baht / Register 20 Baht</p><p>(Ex. EMS)</p>
		<input type="text" name="Shipping">
	
	
	<h5>Your Bank</h5>
	<div class="cons_input">
		<select class="bank_input" name="UserBank" id="UserBank">
			<option value="0" selected="selected">Select</option><option value="1">Bangkok Bank</option><option value="2">Bank Krungsri</option><option value="3">Kasikorn Bank</option><option value="4">Krung Thai Bank</option><option value="5">TMB Bank</option><option value="6">Other Bank</option>
		</select>
   	</div>
   
   <br>
	<h5>Payment date</h5><p>(Ex. DD/MM/YYYY)</p>
		<input type="text" name="PaymentDate">
	</br>	
	<br>
	<h5>Payment time</h5><p>(Ex. HH:MM:SS AM/PM)</p>
    ...
    <br>
    <h5>Please click to upload receipt</h5>	
	<input type="file" accept="image/*" onchange="loadFile(event)">
		<img name="output" id="output" style="width:300px;height:300px;"/>
			<script>
