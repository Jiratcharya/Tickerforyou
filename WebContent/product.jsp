...
<div class="product-model">	 
	 <div class="container">
		 ...
		 <div class="col-md-9 product-model-sec">
					 <a href="single.jsp"><div class="product-grid">
						...
						<form action = "addtocart.jsp?id=" method = "post">	
							<div class="product-info-cust prt_name">
								<h4><input type = "text" value = "BEAGLE LINE" readonly name="ProductName" ></h4>								
								<h5> <input class="item_price" type = "text" value = "65" readonly name="ProductPrice" ></h5>	
					 ...
					 <a href="single2.jsp"><div class="product-grid">
						<div class="more-product"><span> </span></div>						
						<div class="product-img b-link-stripe b-animate-go  thickbox">
							<img src="images/st02.jpg" class="img-responsive" alt=""/>
							<div class="b-wrapper">
							<h4 class="b-animate b-from-left  b-delay03">							
							<button><span class="glyphicon glyphicon-zoom-in" aria-hidden="true"></span>Quick View</button>
							</h4>
						...
						<form action = "addtocart.jsp?id=" method = "post">	
							<div class="product-info-cust prt_name">
								<h4><input type = "text" value = "GG CHANKAIHUN" readonly name="ProductName" ></h4>								
								<h5> <input class="item_price" type = "text" value = "45" readonly name="ProductPrice" ></h5>	
							<input type = "text" value = "1" name = "Quanity" >
								<button type = "submit" class="add-cart item_add">ADD</button>
								<div class="clearfix"> </div>
							</div>		
					...
					<a href="single3.jsp"><div class="product-grid">
						<div class="more-product"><span> </span></div>						
						<div class="product-img b-link-stripe b-animate-go  thickbox">
							<img src="images/st03.jpg" class="img-responsive" alt=""/>
							<div class="b-wrapper">
							<h4 class="b-animate b-from-left  b-delay03">							
							<button><span class="glyphicon glyphicon-zoom-in" aria-hidden="true"></span>Quick View</button>
							</h4>
						...
						<form action = "addtocart.jsp?id=" method = "post">	
							<div class="product-info-cust prt_name">
								<h4><input type = "text" value = "GG LITTLE HUNNIE" readonly name="ProductName" ></h4>								
								<h5> <input class="item_price" type = "text" value = "45" readonly name="ProductPrice" ></h5>	
							<input type = "text" value = "1" name = "Quanity">
								<button type = "submit" class="add-cart item_add">ADD</button>
								<div class="clearfix"> </div>
					...
					<a href="single4.jsp"><div class="product-grid">
						<div class="more-product"><span> </span></div>						
						<div class="product-img b-link-stripe b-animate-go  thickbox">
							<img src="images/st04.jpg" class="img-responsive" alt=""/>
							<div class="b-wrapper">
							<h4 class="b-animate b-from-left  b-delay03">							
							<button><span class="glyphicon glyphicon-zoom-in" aria-hidden="true"></span>Quick View</button>
							</h4>
						...
						<form action = "addtocart.jsp?id=" method = "post">	
							<div class="product-info-cust prt_name">
								<h4><input type = "text" value = "EXO ANIMALS" readonly name="ProductName" ></h4>								
								<h5> <input class="item_price" type = "text" value = "50" readonly name="ProductPrice" ></h5>	
							<input type = "text" value = "1" name = "Quanity">
								<button type = "submit" class="add-cart item_add">ADD</button>
								<div class="clearfix"> </div>
							</div>	
					...
					<a href="single5.jsp"><div class="product-grid">
						<div class="more-product"><span> </span></div>						
						<div class="product-img b-link-stripe b-animate-go  thickbox">
							<img src="images/st05.jpg" class="img-responsive" alt=""/>
							<div class="b-wrapper">
							<h4 class="b-animate b-from-left  b-delay03">							
							<button><span class="glyphicon glyphicon-zoom-in" aria-hidden="true"></span>Quick View</button>
							</h4>
					...
					<a href="single6.jsp"><div class="product-grid">
						<div class="more-product"><span> </span></div>						
						<div class="product-img b-link-stripe b-animate-go  thickbox">
							<img src="images/st06.jpg" class="img-responsive" alt=""/>
							<div class="b-wrapper">
							<h4 class="b-animate b-from-left  b-delay03">							
							<button><span class="glyphicon glyphicon-zoom-in" aria-hidden="true"></span>Quick View</button>
							</h4>
						...
						<form action = "addtocart.jsp?id=" method = "post">	
							<div class="product-info-cust prt_name">
								<h4><input type = "text" value = "EXO STICKER SET" readonly name="ProductName" ></h4>								
								<h5> <input class="item_price" type = "text" value = "450" readonly name="ProductPrice" ></h5>	
							<input type = "text" value = "1" name = "Quanity">
								<button type = "submit" class="add-cart item_add">ADD</button>
								<div class="clearfix"> </div>
							</div>
					...
					<a href="single7.jsp"><div class="product-grid">
						<div class="more-product"><span> </span></div>						
						<div class="product-img b-link-stripe b-animate-go  thickbox">
							<img src="images/st07.jpg" class="img-responsive" alt=""/>
							<div class="b-wrapper">
							<h4 class="b-animate b-from-left  b-delay03">							
							<button><span class="glyphicon glyphicon-zoom-in" aria-hidden="true"></span>Quick View</button>
							</h4>
						...
						<form action = "addtocart.jsp?id=" method = "post">	
							<div class="product-info-cust prt_name">
								<h4><input type = "text" value = "EXO RAINCOAT" readonly name="ProductName" ></h4>								
								<h5> <input class="item_price" type = "text" value = "50" readonly name="ProductPrice" ></h5>	
							<input type = "text" value = "1" name = "Quanity">
								<button type = "submit" class="add-cart item_add">ADD</button>
								<div class="clearfix"> </div>
