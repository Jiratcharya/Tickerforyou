...
<div class="product-model">	 
	 <div class="container">
		 ...
		 <div class="col-md-9 product-model-sec">
					 <a href="singleFan1.jsp"><div class="product-grid">
						...
						<form action = "addtocart.jsp?id=" method = "post">	
							<div class="product-info-cust prt_name">
								<h4><input type = "text" value = "SEHUN & SUHO" readonly name="ProductName" ></h4>								
					 ...
					 <a href="singleFan2.jsp"><div class="product-grid">
						<div class="more-product"><span> </span></div>						
						<div class="product-img b-link-stripe b-animate-go  thickbox">
							<img src="images/fan02.jpg" class="img-responsive" alt=""/>
							<div class="b-wrapper">
							<h4 class="b-animate b-from-left  b-delay03">							
							<button><span class="glyphicon glyphicon-zoom-in" aria-hidden="true"></span>Quick View</button>
							</h4>
						...
						<div class="product-info simpleCart_shelfItem">
							<form action = "addtocart.jsp?id=" method = "post">	
							<div class="product-info-cust prt_name">
								<h4><input type = "text" value = "ALL MEMBER 1" readonly name="ProductName" ></h4>								
								<h5> <input class="item_price" type = "text" value = "70" readonly name="ProductPrice" ></h5>	
							<input type = "text" value = "1" name = "Quanity">
								<button type = "submit" class="add-cart item_add">ADD</button>
								<div class="clearfix"> </div>
							</div>												
					...
					<a href="singleFan3.jsp"><div class="product-grid">
						<div class="more-product"><span> </span></div>						
						<div class="product-img b-link-stripe b-animate-go  thickbox">
							<img src="images/fan03.jpg" class="img-responsive" alt=""/>
							<div class="b-wrapper">
							<h4 class="b-animate b-from-left  b-delay03">							
							<button><span class="glyphicon glyphicon-zoom-in" aria-hidden="true"></span>Quick View</button>
							</h4>
						...
						<div class="product-info simpleCart_shelfItem">
							<form action = "addtocart.jsp?id=" method = "post">	
							<div class="product-info-cust prt_name">
								<h4><input type = "text" value = "ALL MEMBER 2" readonly name="ProductName" ></h4>								
								<h5> <input class="item_price" type = "text" value = "70" readonly name="ProductPrice" ></h5>	
							<input type = "text" value = "1" name = "Quanity">
								<button type = "submit" class="add-cart item_add">ADD</button>
								<div class="clearfix"> </div>
