			 ...
			 <div class="top-sing">
				  <div class="col-md-7 single-top">	
					 <div class="flexslider">
							  <ul class="slides">
								<li data-thumb="images/stbig02.jpg">
									<div class="thumb-image"> <img src="images/stbig02.jpg" data-imagezoom="true" class="img-responsive" alt=""/> </div>
								</li>
							  </ul>
						</div>					 					 
			     ...
			     <div class="col-md-5 single-top-in simpleCart_shelfItem">
					  <div class="single-para ">
						 <h4><input type = "text" value = "EXO MICKEY" readonly name="ProductName"></h4>							
							<h5> <input class="item_price" type = "text" value = "180" readonly name="ProductPrice" ></h5>	
							<input type = "text" value = "1" name = "Quanity" readonly>						
							<p class="para"> Sticker: Exo Mickey / Size: A5 / White BG</p>
