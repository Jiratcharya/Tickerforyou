...
<!--header-->
	...
	<div class="header-top">
		...
		<div class="clearfix"></div>
		<div> <center><font size = "10"> Edit user</font></center><br></div>
	</div>
	<!---->
...
<form method="post" name="form1" onSubmit="JavaScript:return fncSubmit();" action ="updateuser.jsp" >
...
<h5>UserID : </h5> 
<input type="text" name="UserID" value="<%=emp.getUserID()%>"><BR/>
...
<h5> Password : </h5>
<input type="text" name="Password" value="<%=emp.getPassword()%>"><BR/>

<h5> Address : </h5>
<input type="text" name="Address" value="<%=emp.getAddress()%>"><BR/>
