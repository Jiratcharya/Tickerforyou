			 ...
			 <div class="top-sing">
				  <div class="col-md-7 single-top">	
					 <div class="flexslider">
							  <ul class="slides">
								<li data-thumb="images/st07.jpg">
									<div class="thumb-image"> <img src="images/st07.jpg" data-imagezoom="true" class="img-responsive" alt=""/> </div>
								</li>
							  </ul>
						</div>					 					 
			     ...
			     <div class="col-md-5 single-top-in simpleCart_shelfItem">
					  <div class="single-para ">
						 <h4><input type = "text" value = "EXO RAINCOAT" readonly name="ProductName"></h4>							
							...
							<p class="para"> Sticker: Exo Raincoat / Size: 9x15 cm / White BG</p>
