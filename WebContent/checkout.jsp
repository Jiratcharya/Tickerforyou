...
<html>
<head>
<title>Ticker for you | Checkout</title>
	...
	<div class="container">
		<div class="check-sec">
				...
				<div class="cart-header">
					...
					<div class="cart-sec simpleCart_shelfItem">
						...
						<div class="cart-item-info">
							<h3>
								<a><%=emplist.get(i).getProductName()%></a><span></span>
							</h3>
							<ul class="qty">
								<li><p>
										Qty :
										<%=emplist.get(i).getQuanity()%></p></li>
							</ul>
							<div>
									<a href="editcart.jsp?id=<%=emplist.get(i).getId()%>">Edit
										/ </a> <a href="deletecart.jsp?id=<%=emplist.get(i).getId()%>">Delete</a>
					</div>
						</div>
						<div class="clearfix"></div>
					</div>
			...
			<div class="col-md-3 cart-total">
				<a class="continue" href="product.jsp">Continue to Shopping </a>
				<div class="price-details">
					...
					<h3>Price Details</h3>
					<span>Total</span>
					<%=emplist.get(i).getProductPrice()%>

					<span>Total Quantity</span> <span><%=emplist.get(i).getQuanity()%></span>
					<div class="clearfix"></div>
					<%
						}
					%>
				...
				<div class="clearfix"></div>
				<div class="clearfix"></div>
				<a class="order" href="payment.jsp?id=<%=session.getAttribute("idd") %>">Comfirm Order</a>
