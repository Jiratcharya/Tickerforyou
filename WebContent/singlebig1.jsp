			 ...
			 <div class="top-sing">
				  <div class="col-md-7 single-top">	
					 <div class="flexslider">
							  <ul class="slides">
								<li data-thumb="images/stbig01.jpg">
									<div class="thumb-image"> <img src="images/stbig01.jpg" data-imagezoom="true" class="img-responsive" alt=""/> </div>
								</li>
							  </ul>
						</div>					 					 
			     ...
			     <div class="col-md-5 single-top-in simpleCart_shelfItem">
					  <div class="single-para ">
						 <h4><input type = "text" value = "LOVE ME RIGHT" readonly name="ProductName"></h4>							
							<h5> <input class="item_price" type = "text" value = "360" readonly name="ProductPrice" ></h5>	
							<input type = "text" value = "1" name = "Quanity" readonly>						
							<p class="para"> Sticker: Love me right / Size: 5x8 cm / White BG</p>
