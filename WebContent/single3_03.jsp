			 ...
			 <div class="top-sing">
				  <div class="col-md-7 single-top">	
					 <div class="flexslider">
							  <ul class="slides">
								<li data-thumb="images/stb01.jpg">
									<div class="thumb-image"> <img src="images/stb02.jpg" data-imagezoom="true" class="img-responsive" alt=""/> </div>
								</li>
							  </ul>
						</div>					 					 
			     ...
			     <div class="col-md-5 single-top-in simpleCart_shelfItem">
					  <div class="single-para ">
						 <h4><input type = "text" value = "BEAKHYUN 0506" readonly name="ProductName"></h4>							
							<h5> <input class="item_price" type = "text" value = "120" readonly name="ProductPrice" ></h5>	
							<input type = "text" value = "1" name = "Quanity" readonly>						
							<p class="para"> Phone case: Beakhyun 0506 / iPhone : 5/5S/6/6+/6S/6S+ / PVC</p>
