			 ...
			 <div class="top-sing">
				  <div class="col-md-7 single-top">	
					 <div class="flexslider">
							  <ul class="slides">
								<li data-thumb="images/fan03.jpg">
									<div class="thumb-image"> <img src="images/fan03.jpg" data-imagezoom="true" class="img-responsive" alt=""/> </div>
								</li>
							  </ul>
						</div>					 					 
			     ...
			     <div class="col-md-5 single-top-in simpleCart_shelfItem">
					  <div class="single-para ">
						 <h4><input type = "text" value = "ALL MEMBER 2" readonly name="ProductName"></h4>							
							...
							<p class="para"> Fan : All Exo Member / Size: 20x20 cm / Plastic</p>
